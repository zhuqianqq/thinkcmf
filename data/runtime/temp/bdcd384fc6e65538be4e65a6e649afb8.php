                    ...
                    <div class="blog-item">
                        <div class="row">
                            <div class="col-lg-2 col-sm-2 text-right">
                                <div class="date-wrap">
                                    <span class="date"><?php echo cmf_get_date($vo['published_time'],'j'); ?></span>
                                    <span class="month"><?php echo cmf_get_date($vo['published_time'],'n月 Y'); ?></span>
                                </div>
                                <!-- <?php if(!(empty($vo['post_source']) || (($vo['post_source'] instanceof \think\Collection || $vo['post_source'] instanceof \think\Paginator ) && $vo['post_source']->isEmpty()))): ?>
                                    <div class="author"> 来源：<a><?php echo $vo['post_source']; ?></a></div>
                                <?php endif; if(!(empty($vo['post_keywords']) || (($vo['post_keywords'] instanceof \think\Collection || $vo['post_keywords'] instanceof \think\Paginator ) && $vo['post_keywords']->isEmpty()))): $post_keywords=explode(',',$vo['post_keywords']); ?>
                                    <ul class="list-unstyled">
                                        <?php if(is_array($post_keywords) || $post_keywords instanceof \think\Collection || $post_keywords instanceof \think\Paginator): if( count($post_keywords)==0 ) : echo "" ;else: foreach($post_keywords as $key=>$v): ?>
                                            <li><em><?php echo $v; ?></em></a></li>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </ul>
                                <?php endif; ?>
                                <div class="st-view">
                                    <ul class="list-unstyled">
                                        <li><a href="javascript:;"><?php echo $vo['post_hits']; ?> 查看</a></li>
                                        <li><a href="javascript:;"><?php echo $vo['post_like']; ?> 收藏</a></li>
                                        <li><a href="javascript:;"><?php echo $vo['comment_count']; ?> 回复</a></li>
                                    </ul>
                                </div> -->
                            </div>
                            <div class="col-lg-10 col-sm-10">
                                <?php if(!(empty($vo['more']['thumbnail']) || (($vo['more']['thumbnail'] instanceof \think\Collection || $vo['more']['thumbnail'] instanceof \think\Paginator ) && $vo['more']['thumbnail']->isEmpty()))): ?>
                                    <a href="<?php echo cmf_url('portal/Article/index',['id'=>$vo['id'],'cid'=>$category['id']]); ?>">
