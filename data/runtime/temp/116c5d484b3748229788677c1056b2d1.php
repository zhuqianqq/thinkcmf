<?php /*a:2:{s:96:"D:\phpstudy_pro\WWW\thinkcmf5_1_5\public/themes/admin_simpleboot3/portal\admin_article\edit.html";i:1591321010;s:84:"D:\phpstudy_pro\WWW\thinkcmf5_1_5\public/themes/admin_simpleboot3/public\header.html";i:1591067483;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="col-md-9">
                <table class="table table-bordered">
                    ...
                    <?php 
                        ...
                        $json_content = $post['json_content'] ? json_decode($post['json_content'],true) : '';

                     if(!(empty($json_content) || (($json_content instanceof \think\Collection || $json_content instanceof \think\Paginator ) && $json_content->isEmpty()))): if(is_array($json_content) || $json_content instanceof \think\Collection || $json_content instanceof \think\Paginator): if( count($json_content)==0 ) : echo "" ;else: foreach($json_content as $key=>$vo): ?>

                            <tr class="append_content appends_btn">
                                <th>内容图</th>
                                <td>  

                                    <input type="hidden" value="<?php echo $vo['img']; ?>" name="json_pics[]" id="json_pics<?php echo $key; ?>">
                                    <a href="javascript:uploadOneImage('图片上传','#json_pics<?php echo $key; ?>');"
                                       class="btn btn-default btn-sm">选择图片</a>
                                    <input type="text" value="<?php echo $vo['json_title']; ?>" name="json_title[]" placeholder="主标题">
                                    <input type="text" value="<?php echo $vo['json_subtitle1']; ?>" name="json_subtitle1[]" placeholder="副标题1">
                                    <input type="text" value="<?php echo $vo['json_subtitle2']; ?>" name="json_subtitle2[]" placeholder="副标题2">
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; else: ?>
                            ...
                            <tr class="append_content appends_btn">
                                ...
                                <td>  
                                    ...
                                    <input type="hidden" name="json_pics[]" id="json_pics0" value="">
                                    <a href="javascript:uploadOneImage('图片上传','#json_pics0');"
                                       class="btn btn-default btn-sm">选择图片</a>
                                    <input type="text" name="json_title[]" placeholder="主标题">
                                    <input type="text" name="json_subtitle1[]" placeholder="副标题1">
                                    <input type="text" name="json_subtitle2[]" placeholder="副标题2">
                                    <a href="javascript:;"
                                       class="btn btn-success btn-sm appends">添加</a>
                                </td>
                            </tr>
...
<script>
    ...
    $(".appends").click(function(){
        var len = $(".append_content").length
        var key = len + 1
        $(".appends_btn").after(`${`<tr class="append_content">
            <th>内容图${len}</th>
            <td>
                <input type="hidden" name="json_pics[]" id="json_pics${key}" value="">
                <a href="javascript:uploadOneImage('图片上传','#json_pics${key}');"
                   class="btn btn-default btn-sm">选择图片</a>
               <input type="text" name="json_title[]"  placeholder="主标题">
                <input type="text" name="json_subtitle1[]" placeholder="副标题1">
                <input type="text" name="json_subtitle2[]" placeholder="副标题2">
